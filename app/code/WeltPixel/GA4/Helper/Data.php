...
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    */
     ...
     * @return integer
     */
    public function getCustomerOrderCount($customerId, $customerEmail)
    {
        ...
        $whereCondition  = '';
        if ($customerId) {
            $whereCondition .= ' `customer_id` = ' . $customerId . ' OR ';
        }
        ...
        FROM `" . $tableName . "`
        WHERE `created_at` > '" . $date . "' AND ( " . $whereCondition . "  `customer_email` = '" . $customerEmail . "' )";
