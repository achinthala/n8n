...
namespace Hyva\ClassyLlamaAvaTax\Plugin\Sales\Model\Spi;
...
use Avalara\AvaTax\Plugin\Sales\Model\Spi\InvoiceResource as AvaTaxInvoiceResource;
 ...
 * @codeCoverageIgnore
 */
class InvoiceResource extends AvaTaxInvoiceResource
{
    /**
     * @var AvaTaxLogger
     */
    ...
    public function aroundSave(
        ...
        /**
         * Start if the order status is Suspected Fraud stop invoice to sync avalara
         */
        ...
        /**
         * End if the order status is Suspected Fraud stop invoice to sync avalara
         */
        ...
        if ($this->avaTaxConfig->isModuleEnabled($entity->getStoreId())
            ...
            if ($isObjectNew) {
                ...
                $writer = new \Zend_Log_Writer_Stream(BP . '/var/log/payment_issue_check.log');
                $logger = new \Zend_Log();
                $logger->addWriter($writer);
                $logger->info('avatax InvoiceResource');

                $logger->info('Invoice Id===='.$entity->getEntityId());
                $logger->info('Invoice IncrementId===='.$entity->getIncrementId());
