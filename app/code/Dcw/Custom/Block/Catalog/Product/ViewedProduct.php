...
namespace Dcw\Custom\Block\Catalog\Product;
...
class ViewedProduct extends \Klaviyo\Reclaim\Block\Catalog\Product\ViewedProduct
{
    ...
    public function __construct(
        ...
        parent::__construct($context, $klaviyoScopeSetting, $registry, $imageHelper, $data);
    }
        ...
        if (!$this->price) {
            ...
            if ($_product->getTypeId() == 'configurable') {
                ...
                foreach ($_children as $child) {
                    ...
                    // Initialize lowest price or update if current child price is lower
