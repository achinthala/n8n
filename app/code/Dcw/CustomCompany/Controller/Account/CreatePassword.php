...
use Magento\Customer\Controller\Account\CreatePassword as MagentoCreatePassword;
...
class CreatePassword extends MagentoCreatePassword implements HttpGetActionInterface
{
	/**
