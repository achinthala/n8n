...
class Configure extends \Amasty\RequestQuote\Plugin\Checkout\Controller\Cart\Configure
{
    /**
    ...
    public function aroundExecute(NativeConfigure $subject, \Closure $proceed)
    {
        ...
        if ($id) {
            ...
            // The item was removed from the minicart, skip normal workflow to avoid error message
            // due modification made on Dcw\RequestQuote\Controller\Quote\RemoveFromMinicart
            if (!$quoteItem) {
