...
class AddProductDiscontinuedAttribute implements DataPatchInterface
{
    /**
    ...
    protected function saveAttributes($attributes)
    {
        ...
        foreach ($attributes as $key => $options) {
            ...
            if (!$attribute || !$attribute->getAttributeId()) {
                ...
                $eavSetup->addAttributeToGroup(Product::ENTITY, self::ATTRIBUTE_SET_ID, self::GROUPCODE, $key, 500);
            }
        }
    }
