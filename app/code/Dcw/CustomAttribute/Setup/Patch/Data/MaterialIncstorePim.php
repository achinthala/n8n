...
class MaterialIncstorePim implements DataPatchInterface, PatchRevertableInterface
{
    /**
    ...
    const GROUPCODE = "Custom Attributes";
    ...
    public function apply()
    {
        ...
        $attribute_code = 'incstores_pim_material';
        $eavSetup = $this->eavSetupFactory->create(['setup' => $this->moduleDataSetup]);
        $attribute = $this->eavConfig->getAttribute(Product::ENTITY, $attribute_code);
        if ($attribute || $attribute->getAttributeId()) {
            $eavSetup->removeAttribute(\Magento\Catalog\Model\Product::ENTITY, 'incstores_pim_material');	
        }
            ...
            $eavSetup->addAttributeToGroup(Product::ENTITY, self::ATTRIBUTE_SET_ID, self::GROUPCODE, $attribute_code, 230);
