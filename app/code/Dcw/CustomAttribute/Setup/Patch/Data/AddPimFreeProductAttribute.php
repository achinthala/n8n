...
class AddPimFreeProductAttribute implements DataPatchInterface
{
    /**
    ...
    protected function saveAttributes($attributes)
    {
        ...
        foreach ($attributes as $key => $options) {
            ...
            if (!$attribute || !$attribute->getAttributeId()) {
                ...
                $eavSetup->addAttributeToGroup(Product::ENTITY, self::ATTRIBUTE_SET_ID, self::GROUPCODE, $key, 203);
            }
        }
    }
    ...
    {
        $attributes = [
            "incstores_free_product" => [
                'label' => 'Incstores Free Product',
                'user_defined' => true,
                'required' => false,
                'input' => 'boolean',
                'type' => 'int',
