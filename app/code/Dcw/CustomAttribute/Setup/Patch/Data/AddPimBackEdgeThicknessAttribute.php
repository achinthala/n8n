...
class AddPimBackEdgeThicknessAttribute implements DataPatchInterface
{
    /**
    ...
    private const GROUPCODE = "Custom Attributes";
    ...
    public function apply()
    {
        ...
        $attribute_code = 'incstores_pim_back_edge_thickness';
        $eavSetup = $this->eavSetupFactory->create(['setup' => $this->moduleDataSetup]);
        $attribute = $this->eavConfig->getAttribute(Product::ENTITY, $attribute_code);
        if ($attribute || $attribute->getAttributeId()) {
		$eavSetup->removeAttribute(\Magento\Catalog\Model\Product::ENTITY, 'incstores_pim_back_edge_thickness');	
		}
            $eavSetup->addAttribute(
                ...
                [
                    ...
                    'backend' => '',
                    'frontend' => '',
                    'label' => 'Back Edge Thickness (Inches)',
                    'input' => 'select',
                    'class' => '',
                    'source' => '',
