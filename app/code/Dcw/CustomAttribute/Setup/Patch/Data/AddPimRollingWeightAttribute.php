...
class AddPimRollingWeightAttribute implements DataPatchInterface
{
    /**
    ...
    public function apply()
    {
        ...
        $attribute_code = 'incstores_pim_rolling_weight';
        $eavSetup = $this->eavSetupFactory->create(['setup' => $this->moduleDataSetup]);
        $attribute = $this->eavConfig->getAttribute(Product::ENTITY, $attribute_code);
        if ($attribute || $attribute->getAttributeId()) {
            $eavSetup->removeAttribute(\Magento\Catalog\Model\Product::ENTITY, 'incstores_pim_rolling_weight');	
            }
