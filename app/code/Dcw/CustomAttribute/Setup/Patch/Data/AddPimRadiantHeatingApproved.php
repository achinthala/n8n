...
class AddPimRadiantHeatingApproved implements DataPatchInterface
{
    /**
    ...
    protected function saveAttributes($attributes)
    {
        ...
        foreach ($attributes as $key => $options) {
            ...
            if (!$attribute || !$attribute->getAttributeId()) {
                ...
                $eavSetup->addAttributeToGroup(Product::ENTITY, self::ATTRIBUTE_SET_ID, self::GROUPCODE, $key, 400);
            }
        }
    }
    ...
    {
        $attributes = [
            "incstores_pim_radiant_heating_approved" => [
                'label' => 'Radiant Heating Approved',
                'user_defined' => true,
                'required' => false,
                'input' => 'boolean',
                'type' => 'int',
