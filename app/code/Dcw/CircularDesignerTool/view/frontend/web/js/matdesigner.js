...
function deselect(hottype) {
	...
	if (hottype === 'logo') {
		...
		$('#currentlogo').html(
			'<img src="/static/frontend/Dcw/hyvadesktop/en_US/images/logos/none.png" alt="current logo">'
		);
	} else {
...
function loadLogo(position) {
	...
	if (mat.logos.logo[position - 1] === 0 || typeof mat.logos.logo[position - 1] === 'undefined') {
		...
		$('#currentlogoname')
			...
			.removeClass('selected');
		$('#currentlogo').html(
			'<img src="/static/frontend/Dcw/hyvadesktop/en_US/images/logos/' +
				lname +
...
function selectLogo(name) {
	...
	$('#currentlogoname')
		...
		.removeClass('selected');
	$('#currentlogo').html(
		'<img src="/static/frontend/Dcw/hyvadesktop/en_US/images/logos/' + name + '.png" alt="current logo">'
	);
