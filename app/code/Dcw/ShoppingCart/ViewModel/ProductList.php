...
use Hyva\Theme\ViewModel\ProductList as HyvaProductList;
 ...
 */
class ProductList extends HyvaProductList
{
    /**
    ...
    public function getCrosssellItems(QuoteItem ...$cartItems): array
    {
        ...
        $this->maxCrosssellItemCount = (int)$this->getConfigValue('catalog/magento_targetrule/crosssell_position_limit');
