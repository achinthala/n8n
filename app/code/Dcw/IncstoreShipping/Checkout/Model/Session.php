 ...
 */
namespace Dcw\IncstoreShipping\Checkout\Model;
...
class Session extends \Magento\Checkout\Model\Session
{
        ...
        if ($this->_quote === null) {
            ...
            if ($this->_customer) {
                ...
                try {
                    ...
                    // Customer no longer exists - set customer to null to prevent errors
                    // This can happen if customer was deleted but quote still references them
                }
            }
    ...
    /**
     * Get shipping API data from session
     * @return array|null
     */
    public function getShippingApiDataRaw()
    {
        return $this->getData('shipping_api_data');
    }

    /**
     * Set shipping API data to session
     * @param array $data
     * @return $this
     */
    public function setShippingApiDataRaw($data)
    {
        $this->setData('shipping_api_data', $data);
        return $this;
    }

    /**
     * Get API fail response check flag
     * @return int
     */
    public function getApiFailResponseCheck()
    {
        return (int) $this->getData('api_fail_response_check');
    }

    /**
     * Set API fail response check flag
     * @param int $value
     * @return $this
     */
    public function setApiFailResponseCheck($value)
    {
        $this->setData('api_fail_response_check', $value);
        return $this;
    }

    /**
     * Get API response amount
     * @return float
     */
    public function getApiResponseAmount()
    {
        return (float) $this->getData('api_response_amount');
    }

    /**
     * Set API response amount
     * @param float $amount
     * @return $this
     */
    public function setApiResponseAmount($amount)
    {
        $this->setData('api_response_amount', $amount);
        return $this;
    }

    /**
     * Get calculate shipping flag
     * @return int
     */
    public function getCalculateShipping()
    {
        return (int) $this->getData('calculate_shipping');
    }

    /**
     * Set calculate shipping flag
     * @param int $value
     * @return $this
     */
    public function setCalculateShipping($value)
    {
        $this->setData('calculate_shipping', $value);
        return $this;
    }
}
