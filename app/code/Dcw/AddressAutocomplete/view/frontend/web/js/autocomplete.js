...
define(
    ...
    'jquery',
    'uiComponent',
    'Dcw_AddressAutocomplete/js/google_maps_loader',
                            ...
                            if (enabled === '1') {
                                ...
                                street.each(
                                    function () {
                                        ...
                                        autocomplete = new google.maps.places.Autocomplete((this), options, {types: ['geocode']});
        ...
        var fillInAddress = function () {
            ...
            if (region !== '') {
                ...
                if (uiRegistry.get('checkout.steps.shipping-step.shippingAddress.shipping-address-fieldset.region_id')) {
                    ...
                    if ($('#' + regionDomId).length) {
                       // $('#' + regionDomId).val(region);
                       let selectElement = $('#' + regionDomId);

                        // Find the option with the matching data-title and set it as selected
                        selectElement.find('option').each(function() {
                            if ($(this).data('title') === region) {
