...
define([
    ...
    'jquery',
    'uiRegistry'
], function (poPlaceOrderAction, fullScreenLoader, url, additionalValidators, $, uiRegistry) {
    'use strict';

    var mixin = {
        isTermActive : uiRegistry.get('checkout.steps.billing-step.payment.payments-list.before-place-order.agreements').isAgreementAccepted(),
